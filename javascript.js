/* Hello! */
console.log('NAui V1.4 loaded successfully!');

console.log(window.location.pathname);

if(window.location.href === 'http://nintendoage.com/index.cfm?FuseAction=My.Foes'){
    ...
    if(window.location.pathname === '/forum/messageview.cfm'){
        /* Quick Reply */
